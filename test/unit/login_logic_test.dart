...
void main() {
  ...
  group('Login Logic', () {
    ...
    test('2. SSO URL is constructed correctly (generic, no provider id)', () {
      ...
      // Assert
      expect(
          ssoUrl.toString(), contains('_matrix/client/v3/login/sso/redirect'));
        ...
        ..setLoginFlows([
          LoginFlow.fromJson({
            ...
            'identity_providers': [
              ...
              {'id': 'github', 'name': 'GitHub', 'icon': 'mxc://example/icon'},
            ],
          }),
        ]);
    ...
    test('5. AuthState.hasPasswordFlow returns true when password flow present',
        () {
      final authState = AuthState()
        ..setLoginFlows([
    ...
    test('7. AuthState.hasPasswordFlow returns true when flows are not yet set',
        () {
