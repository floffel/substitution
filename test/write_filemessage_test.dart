...
void main() {
  ...
  group('FileMessageWrite Widget Tests', () {
    ...
    testWidgets('File picker button is present', (WidgetTester tester) async {
      ...
      // File picker button with add icon should be present
      final pickButton = find.byIcon(Icons.add);
    ...
    testWidgets('Send button is present', (WidgetTester tester) async {
      ...
      // Send button with send icon should be present
    ...
    testWidgets('Widget renders with reply to eventId', (WidgetTester tester) async {
      ...
      // Widget should render when eventId is provided for reply
      expect(find.byType(FileMessageWrite), findsOneWidget);
    });
    ...
    testWidgets('Failed file upload shows error dialog', (WidgetTester tester) async {
      ...
      // Widget structure is maintained
      expect(find.byType(FileMessageWrite), findsOneWidget);
    });

    testWidgets('Room info displayed correctly', (WidgetTester tester) async {
      final mockClient = MockClient();
      final mockRoom = MockRoom();
