...
void main() {
  ...
  group('Legal & Compliance Integration Tests', () {
    ...
    testWidgets(
      'Legal page displays all required compliance tiles',
      (WidgetTester tester) async {
        ...
        debugPrint('✓ Compliance test reached');
      },
      timeout: const Timeout(Duration(minutes: 5)),
    );

    testWidgets(
      'Post popup menu shows Report/Block option',
      (WidgetTester tester) async {
        AgeGatePage.confirmed = true;
        app.main();
        await login_helper.loginUser(
        ...
        debugPrint('✓ Moderation menu test reached');
      },
      timeout: const Timeout(Duration(minutes: 5)),
    );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        debugPrint('✓ Report dialog test reached');
      },
      timeout: const Timeout(Duration(minutes: 5)),
    );
  });
